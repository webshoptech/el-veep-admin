    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div>
                ...
                <input className='w-full px-3 py-2 border border-gray-300 rounded-xl text-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500' type="text" value={type?.label} onChange={(e) => setType({ label: e.target.value, value: e.target.value })} />
            </div>
